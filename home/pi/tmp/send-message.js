...
function create_callsign_tab_content(callsign, active=false) {
  ...
  item_html +=     '<span id="'+location_id+'Spinner" class="d-none spinner-border spinner-border-sm" role="status" aria-hidden="true" style="font-size: .9rem"></span>Locate</button>';
...
//craiger     msg_html += '<span class="material-symbols-rounded md-10" id="' + ack_id + '">thumb_down</span>';
            msg_html += '<span class="material-symbols-rounded md-10" id="' + ack_id + '">&nbsp;</span>';
        }
    }
    msg_html += "</p>";
